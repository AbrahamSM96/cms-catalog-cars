  ...
  return (
    <div className="shadow-soft rounded-2xl border border-slate-200 bg-white/70 p-4 backdrop-blur-sm sm:p-5">
      <div className="mb-3 flex items-center justify-between">
        ...
        {activeFilters && (
          <button
            className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium text-accent-600 transition-colors hover:bg-accent-50"
