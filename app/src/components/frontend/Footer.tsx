...
const SOCIALS: { key: keyof NonNullable<Contact["social"]>; label: string; path: string }[] = [
  {
    key: "facebook",
    label: "Facebook",
    ...
    <footer id="contact" className="border-t border-slate-200 bg-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <Link href="/" className="group inline-flex items-center gap-2.5" aria-label="Inicio">
          ...
          {/* Explora */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-900">Explora</h4>
            <ul className="mt-4 space-y-2.5 text-sm text-slate-600">
              ...
              <li>
                <Link href="/ubicaciones" className="transition-colors hover:text-red-600">
                  Ubicaciones
                </Link>
              </li>
              <li>
                <Link href="/contacto" className="transition-colors hover:text-red-600">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          {/* Contacto */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-900">Contacto</h4>
            <ul className="mt-4 space-y-2.5 text-sm text-slate-600">
              <li>
                <a href={telHref} className="transition-colors hover:text-red-600">
                  {phone}
                </a>
              </li>
              {email && (
                <li>
                  <a href={`mailto:${email}`} className="break-all transition-colors hover:text-red-600">
                    {email}
                  </a>
                </li>
              )}
          ...
          {/* CTA */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-900">¿Hablamos?</h4>
            <div className="mt-4 flex flex-col gap-3">
              ...
              <a
                href={telHref}
                className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-900 shadow-soft transition-colors hover:border-red-500 hover:text-red-600"
              >
