    ...
    >
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
          ...
          <Link
            className="group shadow-soft hidden cursor-pointer items-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-900 transition-all duration-300 hover:border-red-500 hover:text-red-600 sm:inline-flex"
            href="/catalogo"
          >
