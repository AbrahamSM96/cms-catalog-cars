    ...
    return (
      <div className="rounded-2xl border border-dashed border-slate-300 bg-white py-12 text-center sm:py-16">
        <div className="mx-auto max-w-md px-6">
          ...
          <a
            className="mt-6 inline-flex cursor-pointer items-center gap-2 rounded-xl bg-accent-600 px-6 py-3 font-semibold text-fixed-white shadow-sm transition-all duration-300 hover:bg-accent-700 hover:shadow-lg hover:shadow-accent-600/25"
            href="/catalogo"
          >
            <svg
              aria-hidden="true"
