...
interface FooterProps {
  ...
  /** How bright the uploaded logo is, so the plate lands on the right theme. */
  logoTone?: LogoTone
  site: SiteConfig
}
 ...
 * @param props.logoTone - how bright the logo is, so the plate lands on the
 *   theme that would swallow it
    ...
    <footer className="border-t border-slate-200 bg-white" id="contact">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <BrandLogo logoTone={logoTone} site={site} />
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-3">
              <LeadLink
                className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl bg-green-600 px-5 py-3 text-sm font-semibold text-fixed-white shadow-sm transition-all duration-300 hover:bg-green-700 hover:shadow-green-600/30"
        ...
        {/* Bottom bar */}
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-slate-100 pt-6 sm:mt-12 sm:flex-row">
