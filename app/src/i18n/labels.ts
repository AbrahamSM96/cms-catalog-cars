  ...
  fields: {
    ...
    coordinates: {
      description: msg(
        ...
        'Se llenan solas al guardar con el enlace de Google Maps de arriba: déjalas vacías y pega el enlace. Si las pones a mano, usa grados DECIMALES (ej. 20.6597 y -103.3496), no grados-minutos-segundos: clic derecho en el lugar en Google Maps → clic en las coordenadas para copiarlas.'
      ),
    ...
    googleMapsUrl: {
      description: msg(
        ...
        "Para el botón 'Cómo llegar'. Pega el enlace del botón Compartir de Google Maps: las coordenadas de abajo se sacan de ahí al guardar."
      ),
    },
    latitude: {
