...
export default function Loading(): React.JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Skeleton hero (light) */}
      <div className="bg-gradient-to-b from-white via-slate-50 to-white pt-32 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-14 aspect-[21/9] w-full max-w-6xl animate-pulse rounded-3xl bg-slate-200" />
        </div>
      </div>
